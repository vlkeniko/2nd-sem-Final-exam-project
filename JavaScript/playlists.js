...
// const sunVinylMobile = document.getElementsByClassName("sun-vinyl-mobile");
// // const daySpotify = document.getElementById("day-spotify");
...
// // Create a function that shows/hides the Spotify playlist if you click on the Vinyl image
// sunVinylMobile.onclick = function () {
//   // If the Spotify playlist isn't shown
//   if (daySpotify.style.display !== "block" && $(window).width() <= 620) {
//     // then show it
//     daySpotify.style.display = "block";

//     document.body.style.backgroundImage = "url(/Pictures/mobile/playlist-extended_mobile.png)";
...
//     document.body.style.backgroundImage = "url(/Pictures/playlist-extended_mobile.png)";

//     // moonVinyl.classList.remove("margin-top-extended-bgk");
//   }

//     else {
//       document.body.style.backgroundImage = "url(playlist-small_mobile.png)";
...
// // Declare the variables for the Moon-Vinyl & Night Spotify
// const moonVinylMobile = document.getElementsByClassName("moon-vinyl-mobile");
// // const nightSpotify = document.getElementById("night-spotify");

// // Create a function that shows/hides the Spotify playlist if you click on the Vinyl image
// moonVinylMobile.onclick = function () {
//   // If the Spotify playlist isn't shown
//   if (nightSpotify.style.display !== "block") {
//     // then show it
//     nightSpotify.style.display = "block";
